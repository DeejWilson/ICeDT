EPIC_Extract <- function(bulk, reference=NULL, mRNA_cell=NULL, mRNA_cell_sub=NULL,
                 sigGenes=NULL, scaleExprs=TRUE, withOtherCells=TRUE,
                 constrainedSum=TRUE, rangeBasedOptim=FALSE,prebuiltRefNames=c("BRef","TRef")){
  ...
  return(list(mRNAProportions=mRNAProportions, cellFractions=cellFractions,
              fit.gof=fit.gof,bulk=bulk,ref=refProfiles,var=refProfiles.var))
}
